...
- 柱体（hist）放大 = 乖离扩散 = 强度增强
- 柱体收缩 = 均线密集 = 强度收敛
- DIF 在 0 轴上方/下方 = 多头/空头排列方向
...
| 交叉 | **可以表达** | DIF 与 DEA 金叉/死叉 |
| 多头排列 + 乖离率 | **可以表达** | DIF 的 0 轴方向 + 柱体幅度（扩散/收敛） |
...
| 多头扩散 | 支持 | DIF 在 0 轴上方，柱体放大 = 乖离扩散，多头强度增强 |
| 多头收敛 | 中性 | DIF 在 0 轴上方，柱体收缩 = 均线趋密集，多头强度衰减 |
| 空头扩散 | 冲突 | DIF 在 0 轴下方，柱体放大 = 空头乖离扩散 |
| 空头收敛 | 中性 | DIF 在 0 轴下方，柱体收缩 = 空头强度衰减 |
