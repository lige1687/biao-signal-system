...
INSTRUMENTS: dict[str, InstrumentSpec] = {
    ...
    "XLK": _spec("XLK", "科技ETF", "us", "sp500", "yf", "XLK", 1.0, "含分红复权，" + _US_NOTE),
    "SMH": _spec("SMH", "半导体ETF", "us", "sp500", "yf", "SMH", 1.0, "含分红复权，" + _US_NOTE),
    "XLE": _spec("XLE", "能源ETF", "us", "sp500", "yf", "XLE", 1.0, "含分红复权，" + _US_NOTE),
    "XLF": _spec("XLF", "金融ETF", "us", "sp500", "yf", "XLF", 1.0, "含分红复权，" + _US_NOTE),
    "XLV": _spec("XLV", "医疗ETF", "us", "sp500", "yf", "XLV", 1.0, "含分红复权，" + _US_NOTE),
    "XLY": _spec("XLY", "可选消费ETF", "us", "sp500", "yf", "XLY", 1.0, "含分红复权，" + _US_NOTE),
    "XLP": _spec("XLP", "必选消费ETF", "us", "sp500", "yf", "XLP", 1.0, "含分红复权，" + _US_NOTE),
    "XLI": _spec("XLI", "工业ETF", "us", "sp500", "yf", "XLI", 1.0, "含分红复权，" + _US_NOTE),
    "XLB": _spec("XLB", "材料ETF", "us", "sp500", "yf", "XLB", 1.0, "含分红复权，" + _US_NOTE),
    "XLRE": _spec("XLRE", "地产ETF", "us", "sp500", "yf", "XLRE", 1.0, "含分红复权，" + _US_NOTE),
    "XLU": _spec("XLU", "公用事业ETF", "us", "sp500", "yf", "XLU", 1.0, "含分红复权，" + _US_NOTE),
    "XBI": _spec("XBI", "生物科技ETF", "us", "sp500", "yf", "XBI", 1.0, "含分红复权，" + _US_NOTE),
    "IWM": _spec("IWM", "小盘罗素ETF", "us", "sp500", "yf", "IWM", 1.0, "含分红复权，" + _US_NOTE),
    "DIA": _spec("DIA", "道指ETF", "us", "sp500", "yf", "DIA", 1.0, "含分红复权，" + _US_NOTE),
    "EFA": _spec("EFA", "发达市场ETF", "us", "sp500", "yf", "EFA", 1.0, "含分红复权，" + _US_NOTE),
    "EEM": _spec("EEM", "新兴市场ETF", "us", "sp500", "yf", "EEM", 1.0, "含分红复权，" + _US_NOTE),
    "GLD": _spec("GLD", "黄金ETF(对照)", "us", "sp500", "yf", "GLD", 1.0, "复权价，宽度无关对照"),
