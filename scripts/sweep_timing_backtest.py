...
def main() -> None:
    ...
    ap.add_argument("--grid", default="v1", choices=["v1", "v2", "v3", "v4", "v5", "v6"],
    ...
    grid = (
        {"v2": build_grid_v2, "v3": build_grid_v3, "v4": build_grid_v4,
         "v5": build_grid_v5, "v6": build_grid_v6}.get(args.grid, build_grid)
    )(symbols, indicators)
    ...
    prefix = {"v1": "sweep", "v2": "sweep2", "v3": "sweep3", "v4": "sweep4",
              "v5": "sweep5", "v6": "sweep6"}[args.grid]
    report_name = {"v1": "report", "v2": "report2", "v3": "report3",
                   "v4": "report4", "v5": "report5", "v6": "report6"}[args.grid]
